  ...
  handleServerTokenResponse(serverTokenResponse, authority, reqTimestamp, request, authCodePayload, userAssertionHash, handlingRefreshTokenResponse, forceCacheRefreshTokenResponse, serverRequestId) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        yield this.cacheStorage.saveCacheRecord(cacheRecord, request.storeInCache);
      } finally {
...
var SilentFlowClient = class extends BaseClient {
  ...
  acquireToken(request) {
    return __async(this, null, function* () {
      try {
        const [authResponse, cacheOutcome] = yield this.acquireCachedToken(request);
...
var PerformanceClient = class {
  ...
  startMeasurement(measureName, correlationId) {
    ...
    return {
        ...
        return this.endMeasurement(__spreadValues(__spreadValues({}, inProgressEvent), event));
      },
      discard: () => {
...
var CryptoKeyStore = class {
  ...
  clear() {
    return __async(this, null, function* () {
      ...
      try {
        yield this.asymmetricKeys.clearPersistent();
        return true;
      } catch (e) {
...
var CryptoOps = class _CryptoOps {
  ...
  getPublicKeyThumbprint(request) {
    return __async(this, null, function* () {
      ...
      yield this.cache.asymmetricKeys.setItem(publicJwkHash, {
  ...
  removeTokenBindingKey(kid) {
    return __async(this, null, function* () {
      yield this.cache.asymmetricKeys.removeItem(kid);
      const keyFound = yield this.cache.asymmetricKeys.containsKey(kid);
      return !keyFound;
    });
  }
  /**
  ...
  signJwt(payload, kid, shrOptions, correlationId) {
    return __async(this, null, function* () {
      ...
      const cachedKeyPair = yield this.cache.asymmetricKeys.getItem(kid);
      if (!cachedKeyPair) {
...
@azure/msal-browser/dist/event/EventHandler.mjs:
  (*! @azure/msal-browser v3.10.0 2024-02-17 *)
*/
//# sourceMappingURL=chunk-XU4WRQPX.js.map
