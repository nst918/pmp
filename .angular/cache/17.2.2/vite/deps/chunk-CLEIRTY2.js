  ...
  initializeBaseRequest(request) {
    return __async(this, null, function* () {
      ...
      !StringUtils.isEmptyObj(request.claims)) {
        validatedRequest.requestedClaimsHash = yield this.browserCrypto.hashString(request.claims);
      }
...
var StandardInteractionClient = class extends BaseInteractionClient {
  ...
  initializeAuthorizationRequest(request, interactionType) {
    return __async(this, null, function* () {
      ...
      const baseRequest = yield invokeAsync(this.initializeBaseRequest.bind(this), PerformanceEvents.InitializeBaseRequest, this.logger, this.performanceClient, this.correlationId)(request);
...
var SilentCacheClient = class extends StandardInteractionClient {
  ...
  acquireToken(silentRequest) {
    return __async(this, null, function* () {
      ...
      const silentAuthClient = yield this.createSilentFlowClient(serverTelemetryManager, silentRequest.authority, silentRequest.azureCloudOptions, silentRequest.account);
   ...
   * @param authorityUrl
   */
  createSilentFlowClient(serverTelemetryManager, authorityUrl, azureCloudOptions, account) {
    return __async(this, null, function* () {
...
var RedirectClient = class extends StandardInteractionClient {
   ...
   * @param correlationId {string?} correlation identifier
   */
  handleRedirectPromise(hash, performanceClient, correlationId) {
    return __async(this, null, function* () {
...
var SilentRefreshClient = class extends StandardInteractionClient {
  ...
  acquireToken(request) {
    return __async(this, null, function* () {
      ...
      const baseRequest = yield invokeAsync(this.initializeBaseRequest.bind(this), PerformanceEvents.InitializeBaseRequest, this.logger, this.performanceClient, request.correlationId)(request);
...
var StandardController = class _StandardController {
      ...
      try {
        if (request.code && request.nativeAccountId) {
          ...
          if (this.canUseNative(request, request.nativeAccountId)) {
            return yield this.acquireTokenNative(__spreadProps(__spreadValues({}, request), {
              correlationId
   ...
   */
  acquireTokenFromCache(silentCacheClient, commonRequest, cacheLookupPolicy) {
    return __async(this, null, function* () {
  ...
  acquireTokenSilentAsync(request, account) {
    return __async(this, null, function* () {
      ...
      if (NativeMessageHandler.isNativeAvailable(this.config, this.logger, this.nativeExtensionProvider, request.authenticationScheme) && account.nativeAccountId) {
        ...
        result = this.acquireTokenNative(silentRequest, ApiId.acquireTokenSilent_silentFlow).catch((e) => __async(this, null, function* () {
          if (e instanceof NativeAuthError && isFatalNativeAuthError(e)) {
        ...
        const silentRequest = yield invokeAsync(silentCacheClient.initializeSilentRequest.bind(silentCacheClient), PerformanceEvents.InitializeSilentRequest, this.logger, this.performanceClient, request.correlationId)(request, account);
...
@azure/msal-browser/dist/controllers/StandardController.mjs:
  (*! @azure/msal-browser v3.10.0 2024-02-17 *)
*/
//# sourceMappingURL=chunk-CLEIRTY2.js.map
